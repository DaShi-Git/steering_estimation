...
def addLayer(img, dirct):
    ...
    additionLayer = np.ones((512,512,1))
    ...
    img = np.concatenate((img, additionLayer*(dirct)), axis=2)
...
class DepthDatasetLoader(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        rgb_img_file1 = rgb_img_file[0:18]+'1'+rgb_img_file[19::]
        rgb_img_file2= rgb_img_file[0:18]+'2'+rgb_img_file[19::]
        #print(rgb_img_file)
        rgb_img0 = read_rgb(rgb_img_file)
        rgb_img1 = read_rgb(rgb_img_file1)
        rgb_img2 = read_rgb(rgb_img_file2)
        ...
        rgb_img0 = addLayer(rgb_img0,dirct=0.0)
        rgb_img1 = addLayer(rgb_img1,dirct=0.5)
        rgb_img2 = addLayer(rgb_img2,dirct=-0.5)
        ...
        rgb = np.concatenate((rgb_img0,rgb_img1,rgb_img2), axis=2)
        data['rgb'] = rgb.copy()
        ...
        steer = self.drivedata.iloc[curnum]['steer']
        steer = np.array([steer],dtype='f')
        data['steer'] = steer.copy()
